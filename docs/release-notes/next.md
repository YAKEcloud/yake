...
<details>
<summary><b>Update shoot-dns-service to <code>1.79.0</code></b></summary>

# [github.com/gardener/gardener-extension-shoot-dns-service:v1.79.0]

## 🏃 Others
- `[OPERATOR]` Fix shoot validation for GCP workloadidentity: pass `GCPWorkloadIdentityConfig` by @MartinWeindel [[#675](https://github.com/gardener/gardener-extension-shoot-dns-service/pull/675)]

## Helm Charts
- shoot-dns-service-admission-application: `europe-docker.pkg.dev/gardener-project/releases/charts/gardener/extensions/shoot-dns-service-admission-application:v1.79.0`
- shoot-dns-service-admission-runtime: `europe-docker.pkg.dev/gardener-project/releases/charts/gardener/extensions/shoot-dns-service-admission-runtime:v1.79.0`
- shoot-dns-service: `europe-docker.pkg.dev/gardener-project/releases/charts/gardener/extensions/shoot-dns-service:v1.79.0`
## Container (OCI) Images
- gardener-extension-admission-shoot-dns-service: `europe-docker.pkg.dev/gardener-project/releases/gardener/extensions/admission-shoot-dns-service:v1.79.0`
- gardener-extension-shoot-dns-service: `europe-docker.pkg.dev/gardener-project/releases/gardener/extensions/shoot-dns-service:v1.79.0`


</details>

<details>
<summary><b>Update provider-aws to <code>1.68.1</code></b></summary>

# [github.com/gardener/gardener-extension-provider-aws:v1.68.1]

## 🐛 Bug Fixes
- `[OPERATOR]` Reverted BYO CIDR validation to previous state to address regression by @AndreasBurger [[#1724](https://github.com/gardener/gardener-extension-provider-aws/pull/1724)]

## Helm Charts
- admission-aws-application: `europe-docker.pkg.dev/gardener-project/releases/charts/gardener/extensions/admission-aws-application:v1.68.1`
- admission-aws-runtime: `europe-docker.pkg.dev/gardener-project/releases/charts/gardener/extensions/admission-aws-runtime:v1.68.1`
- provider-aws: `europe-docker.pkg.dev/gardener-project/releases/charts/gardener/extensions/provider-aws:v1.68.1`
## Container (OCI) Images
- gardener-extension-admission-aws: `europe-docker.pkg.dev/gardener-project/releases/gardener/extensions/admission-aws:v1.68.1`
- gardener-extension-provider-aws: `europe-docker.pkg.dev/gardener-project/releases/gardener/extensions/provider-aws:v1.68.1`


</details>

<details>
<summary><b>Update provider-azure to <code>1.58.3</code></b></summary>
...
<details>
<summary><b>Update provider-gcp to <code>1.49.5</code></b></summary>



## Helm Charts
- admission-gcp-application: `europe-docker.pkg.dev/gardener-project/releases/charts/gardener/extensions/admission-gcp-application:v1.49.5`
- admission-gcp-runtime: `europe-docker.pkg.dev/gardener-project/releases/charts/gardener/extensions/admission-gcp-runtime:v1.49.5`
- provider-gcp: `europe-docker.pkg.dev/gardener-project/releases/charts/gardener/extensions/provider-gcp:v1.49.5`
## Container (OCI) Images
- gardener-extension-admission-gcp: `europe-docker.pkg.dev/gardener-project/releases/gardener/extensions/admission-gcp:v1.49.5`
- gardener-extension-provider-gcp: `europe-docker.pkg.dev/gardener-project/releases/gardener/extensions/provider-gcp:v1.49.5`


</details>

<details>
<summary><b>Update provider-openstack to <code>1.52.1</code></b></summary>
...
<details>
<summary><b>Update provider-alicloud to <code>1.69.0</code></b></summary>
