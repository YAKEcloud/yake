...
<details>
<summary><b>Update gardener-controlplane to <code>1.136.3</code></b></summary>
...
<details>
<summary><b>Update gardenlet to <code>1.136.3</code></b></summary>
...
<details>
<summary><b>Update gardener-controlplane to <code>1.136.4</code></b></summary>
...
<details>
<summary><b>Update gardenlet to <code>1.136.4</code></b></summary>
...
<details>
<summary><b>Update gardener-controlplane to <code>1.136.5</code></b></summary>

# [github.com/gardener/gardener:v1.136.5]

## 🐛 Bug Fixes
- `[OPERATOR]` Add a network policy label for allowing communication from the OpenTelemetryCollector in the control plane to the Shoot Kubernetes API Server. by @rrhubenov [[#14222](https://github.com/gardener/gardener/pull/14222)]

## 🏃 Others
- `[OPERATOR]` Add startup probe to gardener-metrics-exporter by @chrkl [[#14226](https://github.com/gardener/gardener/pull/14226)]
- `[OPERATOR]` Fluent-bit resource limits are increased. by @nickytd [[#14210](https://github.com/gardener/gardener/pull/14210)]

## Helm Charts
- controlplane: `europe-docker.pkg.dev/gardener-project/releases/charts/gardener/controlplane:v1.136.5`
- gardenlet: `europe-docker.pkg.dev/gardener-project/releases/charts/gardener/gardenlet:v1.136.5`
- operator: `europe-docker.pkg.dev/gardener-project/releases/charts/gardener/operator:v1.136.5`
- resource-manager: `europe-docker.pkg.dev/gardener-project/releases/charts/gardener/resource-manager:v1.136.5`
## Container (OCI) Images
- admission-controller: `europe-docker.pkg.dev/gardener-project/releases/gardener/admission-controller:v1.136.5`
- apiserver: `europe-docker.pkg.dev/gardener-project/releases/gardener/apiserver:v1.136.5`
- controller-manager: `europe-docker.pkg.dev/gardener-project/releases/gardener/controller-manager:v1.136.5`
- gardenadm: `europe-docker.pkg.dev/gardener-project/releases/gardener/gardenadm:v1.136.5`
- gardenlet: `europe-docker.pkg.dev/gardener-project/releases/gardener/gardenlet:v1.136.5`
- node-agent: `europe-docker.pkg.dev/gardener-project/releases/gardener/node-agent:v1.136.5`
- operator: `europe-docker.pkg.dev/gardener-project/releases/gardener/operator:v1.136.5`
- resource-manager: `europe-docker.pkg.dev/gardener-project/releases/gardener/resource-manager:v1.136.5`
- scheduler: `europe-docker.pkg.dev/gardener-project/releases/gardener/scheduler:v1.136.5`
...
<details>
<summary><b>Update gardenlet to <code>1.136.5</code></b></summary>
...
<details>
<summary><b>Update gardener-controlplane to <code>1.136.7</code></b></summary>

# [github.com/gardener/gardener:v1.136.7]

## 🏃 Others
- `[DEPENDENCY]` The following dependencies have been updated:  
  - `registry.k8s.io/ingress-nginx/controller-chroot` from `v1.14.3` to `v1.14.5`. by @oliver-goetz [[#14400](https://github.com/gardener/gardener/pull/14400)]

## Helm Charts
- controlplane: `europe-docker.pkg.dev/gardener-project/releases/charts/gardener/controlplane:v1.136.7`
- gardenlet: `europe-docker.pkg.dev/gardener-project/releases/charts/gardener/gardenlet:v1.136.7`
- operator: `europe-docker.pkg.dev/gardener-project/releases/charts/gardener/operator:v1.136.7`
- resource-manager: `europe-docker.pkg.dev/gardener-project/releases/charts/gardener/resource-manager:v1.136.7`
## Container (OCI) Images
- admission-controller: `europe-docker.pkg.dev/gardener-project/releases/gardener/admission-controller:v1.136.7`
- apiserver: `europe-docker.pkg.dev/gardener-project/releases/gardener/apiserver:v1.136.7`
- controller-manager: `europe-docker.pkg.dev/gardener-project/releases/gardener/controller-manager:v1.136.7`
- gardenadm: `europe-docker.pkg.dev/gardener-project/releases/gardener/gardenadm:v1.136.7`
- gardenlet: `europe-docker.pkg.dev/gardener-project/releases/gardener/gardenlet:v1.136.7`
- node-agent: `europe-docker.pkg.dev/gardener-project/releases/gardener/node-agent:v1.136.7`
- operator: `europe-docker.pkg.dev/gardener-project/releases/gardener/operator:v1.136.7`
- resource-manager: `europe-docker.pkg.dev/gardener-project/releases/gardener/resource-manager:v1.136.7`
- scheduler: `europe-docker.pkg.dev/gardener-project/releases/gardener/scheduler:v1.136.7`
...
<details>
<summary><b>Update gardenlet to <code>1.136.7</code></b></summary>
