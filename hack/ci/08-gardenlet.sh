...
yq eval '.data."values.yaml"' hack/ci/dev-env/gardenlet/config/internal-gardenlet-values.yaml.tmpl > /tmp/values.yaml
...
yq eval '.data."values.yaml" = strenv(VALUES)' hack/ci/dev-env/gardenlet/config/internal-gardenlet-values.yaml.tmpl > hack/ci/dev-env/gardenlet/config/internal-gardenlet-values.yaml

yq eval '.stringData.token-id = env(TOKEN_ID)' hack/ci/dev-env/gardenlet/garden-content/token.yaml.tmpl > hack/ci/dev-env/gardenlet/garden-content/token.yaml
yq eval '.metadata.name = "bootstrap-token-" + env(TOKEN_ID)' -i hack/ci/dev-env/gardenlet/garden-content/token.yaml
yq eval '.stringData.token-secret = env(TOKEN_ID_SECRET)' -i hack/ci/dev-env/gardenlet/garden-content/token.yaml
...
rm hack/ci/dev-env/gardenlet/garden-content/token.yaml
rm hack/ci/dev-env/gardenlet/config/internal-gardenlet-values.yaml
