...
docker build --build-arg EFFECTIVE_VERSION="$tag"  -t ghcr.io/yakecloud/gardener-extension-provider-local:v"$tag"  -f Dockerfile --target gardener-extension-provider-local .
